...
{
    public class WorkflowPropertyRepository : DataStoreEntityRepositoryBase<WorkflowProperty, DbContext>, IWorkflowPropertiesRepository

    {
        public WorkflowPropertyRepository(
            RepositoryCacheSettings repositoryCacheSettings,
            IRepositoryCacheService<WorkflowProperty> repositoryCacheService,
